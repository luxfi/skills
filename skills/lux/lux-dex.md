# Lux DEX (LX) - Ultra-High Performance Order Matching Engine
...
DAG-based ordering with Quasar certificate consensus and Pulsar post-quantum engine. Security levels: 128, 192, 256 bits.

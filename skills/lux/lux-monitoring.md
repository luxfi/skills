# Lux Monitoring - Full Observability Stack

**Category**: Lux Ecosystem
**Related Skills**: `lux/lux-node.md`, `lux/lux-universe.md`
...
| `CChainNotSyncing` | `rate(avalanche_C_last_accepted_height[5m]) == 0` | 10m | warning |
| `CChainHighRejectionRate` | rejection > 10% of accepted | 5m | warning |
| `PChainNotSyncing` | `rate(avalanche_P_last_accepted_height[5m]) == 0` | 10m | warning |
| `XChainNotSyncing` | `rate(avalanche_X_last_accepted_height[5m]) == 0` | 10m | warning |
| `LowPeerCount` | `avalanche_network_peers < 5` | 10m | warning |
...
| `luxd` | `/avalanche-logs/network_current/node*/logs/*.log` | Multiline, regex for timestamp/level/logger |
...
**Category**: Lux Ecosystem
**Related**: monitoring, grafana, prometheus, loki, alertmanager, observability, dex
**Prerequisites**: Docker, Docker Compose, Prometheus/Grafana basics

# Lux Oracle - Optimistic Oracle for DeFi

**Category**: Lux Ecosystem
**Related Skills**: `lux/lux-exchange.md`, `lux/lux-evm.md`
...
**Category**: Lux Ecosystem
**Related**: oracle, defi, price-feed, uma
**Prerequisites**: Solidity, DeFi concepts

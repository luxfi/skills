# Lux Wallet - Multi-Platform HD Wallet

**Category**: Lux Ecosystem
**Related Skills**: `lux/lux-sdk.md`, `lux/lux-crypto.md`, `lux/lux-safe.md`, `lux/lux-ledger.md`
...
|---|---------|-------|-------------|-------|------|-----|
| 1 | `evm` | Ethereum + all EVM (Avalanche C-Chain, BSC, Polygon, Arbitrum, Optimism, etc.) | SIMPLE | secp256k1 | No | Yes |
...
EVM networks include: Ethereum, Avalanche C-Chain, BSC, Polygon, Arbitrum, Optimism, Fantom, Mantle, Manta Pacific, Blast, and many more via the preset networks configuration.
